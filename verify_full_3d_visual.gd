...
const LIGHT_ON_PREVIEW_PATH := "res://assets/art/environments/dungeon_3d/env_dungeon_runtime_light_on_preview_top3d_v001.png"
const INVENTORY_PREVIEW_PATH := "res://assets/art/ui/inventory_3d/ui_inventory_item_model_preview_v001.png"
