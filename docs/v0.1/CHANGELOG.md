...
- 修复头顶血条的圆角端帽被 Billboard 材质错误放大成彩色球体的问题；现在整条使用单一扁平圆角网格，不再生成额外球状物。
...
## 2026-08-06｜保险柜格子转移、无限库存连续购买与基地币显示
...
- `extraction_points` 保留为兼容存档字段，玩家显示名统一为“基地币”；余额在贩卖机、主基地HUD和塔楼主HUD常驻显示，和局内临时“魂”严格区分。
