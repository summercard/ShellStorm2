...
- 记录ID：DOC-DIFF-20260912；基于同一代码基线交付44项差异统计、214条资产明细和9项已对齐记录。
- 每项区分工程、文档、一致性、是否修改、建议方向与实际修改状态；19项改工程、7项改文档，另18项先确定设计或核验版本。
- 统计与导出内容已核对；本次未据表执行游戏整改。详见[差异表交付记录](2026-09-12_discrepancy_table.md)。
