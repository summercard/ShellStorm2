...
- <span style="color:#2E7D32">**[已实装｜2026-08-07战斗可读性]** 七种敌人使用以旧模型比例为基准的独立体型：炸弹果0.8；远程、追猎与伏击1.0；护卫与召唤1.2；Boss1.5。模型、角色碰撞、头顶锚点同步缩放。所有敌人都有短款圆角头顶血条：深蓝框、冷青强调线、红色生命填充，低血转暖橙；血条脱离怪物的旋转层级、固定在头顶世界坐标并始终朝向摄像机。Boss继续保留HUD总血条并使用更宽的头顶条。</span>
