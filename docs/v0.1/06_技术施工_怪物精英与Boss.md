...
- <span style="color:#2E7D32">**[已实装｜2026-08-06平衡]** 3D Profile原始生命仍为普通怪42–112、Boss 520；最终运行时统一为普通怪×3（126–336）、Boss×10（基线5200），伤害不变。所有怪物最终移动速度为旧值70%；Boss在原楼层体型基础上再×2，视觉与碰撞同步。</span>
...
- [x] 六种普通怪与Boss统一应用普通HP×3/Boss HP×10、全体速度×0.70、Boss体积×2；专项检查最终生命、速度、世界碰撞半径和头顶血条。
