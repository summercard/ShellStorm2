...
const SUN_ENERGY := 0.78
const SUN_COLOR := Color(1.0, 0.88, 0.70)
const BACKGROUND_COLOR := Color(0.32, 0.55, 0.76)
const AMBIENT_COLOR := Color(0.29, 0.36, 0.43)
const AMBIENT_ENERGY := 0.22
const FOG_LIGHT_COLOR := Color(0.24, 0.34, 0.43)
