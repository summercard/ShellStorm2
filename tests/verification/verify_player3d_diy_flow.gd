...
func _ready() -> void:
	...
	if str(avatar_snapshot.get("assembly_version", "")) != "v021" or str(avatar_snapshot.get("rig_type", "")) != "rigid_node_skeleton" or str(avatar_snapshot.get("component_space", "")) != "pivot_local":
