"""Verify evaluated soles and flight in the saved v017 authoring bundle."""
import bpy
import json
from pathlib import Path

ROOT = Path(__file__).resolve().parents[2]
PACKAGE = ROOT / 'assets/art/characters/player/chr_player_capsule01_3d/variants/bunny01/production/v017'
bpy.ops.wm.open_mainfile(filepath=str(PACKAGE / 'source/animation/chr_bunny01_animation_v017.blend'))
results = {}
...
report_path = ROOT / 'outputs/character_pipeline/v017/validation.json'
report = json.loads(report_path.read_text())
report['evaluated_shoe_ground_and_flight'] = results
report_path.write_text(json.dumps(report, ensure_ascii=False, indent=2))
ledger_path = PACKAGE / 'character_transfer_ledger_v017.json'
