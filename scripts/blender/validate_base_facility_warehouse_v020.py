...
# Ground facilities must have disjoint plan envelopes; upper-wall information boards are excluded.
pairs=[]
physical=[x for x in results if not x['collection'].startswith('61_')]
