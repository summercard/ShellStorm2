...
- 反推白盒数据：`source/art/whitebox/tower_zones/v012/data/whitebox_stairs_v012.json`
...
- 回滚白盒：`source/art/whitebox/tower_zones/v011/blender/whitebox_tower_battle_stairs_v011.blend`
