...
cat=json.loads((O/'component_packages_v002/catalog.json').read_text())
...
d.text((32,25),'天台区块  /  模块化组件库 v002',font=title,fill=(235,240,243))
d.text((34,78),'44 个独立资产包  ·  藤蔓墙体系列  ·  加厚门框  ·  外墙主体 5 × 0.30 × 11.9 m',font=f,fill=(170,186,194))
