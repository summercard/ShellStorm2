...
OUT=ROOT+'/assets/art/environments/tower_zones/expedition/source/room_types/l_corridor/v002'
...
base=ROOT+'/assets/art/environments/tower_zones/expedition/source/room_types/l_corridor/v001/component_packages'
...
for e in locked:
    ...
    with open(OUT+'/component_packages/'+category+'/'+slug+'/asset_manifest.json') as f:new=json.load(f)
