...
BLEND_PATH = SOURCE_DIR / "env_tower_descent_kit_top3d_v001.blend"
STACK_PREVIEW = OUTPUT_DIR / "tower_blender_three_floor_stack_v001.png"
ROOF_PREVIEW = OUTPUT_DIR / "tower_blender_rooftop_plan_v001.png"
FACILITY_PREVIEW = OUTPUT_DIR / "tower_blender_facility_plan_v001.png"
COMBAT_PREVIEW = OUTPUT_DIR / "tower_blender_combat_plan_v001.png"
...
def add_lighting(collection):
    ...
    for name, location, energy, size, color in (
        ...
        ("Review_Floor_Roof", (0.0, -92.0, 4.5), 4200.0, 34.0, (0.62, 0.82, 1.0)),
        ("Review_Floor_Facility", (0.0, -92.0, -4.5), 4200.0, 34.0, (0.48, 1.0, 0.78)),
        ("Review_Floor_Combat", (0.0, -92.0, -13.5), 4200.0, 34.0, (1.0, 0.50, 0.38)),
    ):
        ...
        look_at(light, (0.0, 0.0, location[2]))
...
stack_cutaway_objects = [
    obj
    for collection_name in ("03_FLOOR_FACILITY_ZNEG009", "05_FLOOR_COMBAT_ZNEG018")
    for obj in COLLECTIONS[collection_name].objects
    if obj.name.startswith("Facility_South_") or obj.name.startswith("Combat_South_")
]
for obj in stack_cutaway_objects:
